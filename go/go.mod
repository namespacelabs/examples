...
require (
	...
	namespacelabs.dev/integrations/buildkit v0.0.0-20251014083812-d336d2841f96
	namespacelabs.dev/integrations/examples/buildandrun/testserver v0.0.0-20251014083812-d336d2841f96
)
