...
require (
	...
	namespacelabs.dev/integrations/buildkit v0.0.0-20251113161623-efbb64f49b3e
	namespacelabs.dev/integrations/examples/buildandrun/testserver v0.0.0-20251113161623-efbb64f49b3e
)

require (
	buf.build/gen/go/namespace/cloud/grpc/go v1.5.1-20251014083539-aa0729ced7c3.2 // indirect
